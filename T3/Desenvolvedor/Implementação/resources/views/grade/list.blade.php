                        ...
                        <table class="table table-borderless m-b-none">
                            ...
                            @foreach($grades as $grade)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-table-align">
                                            {{ ($grade->starts_at) ? @Carbon\Carbon::createFromFormat('H:i:s',$grade->starts_at)->format('H:i') : ""}}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="btn-table-align">
                                            {{ ($grade->ends_at) ? @Carbon\Carbon::createFromFormat('H:i:s',$grade->ends_at)->format('H:i') : ""}}
                                        </div>
                                    </td>
                                    <td>
